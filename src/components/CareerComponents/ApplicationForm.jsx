            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Lead Behavior Specialist">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Full Time - Day Time">
                    Full Time - Day Time
                  </option>
                  <option value="Part Time - Day Time">
                    Part Time - Day Time
                  </option>
                  <option value="Part Time - Afterschool/Evening">
                    Part Time - Afterschool/Evening
                  </option>
                </select>
                <ChevronDown
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none"
