        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Parent/Guardian Name (Nombre del Padre/Tutor) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Phone Number (Número de Teléfono) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Email Address (Correo Electrónico) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="email" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Home Address (Dirección) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Child's Full Name (Nombre Completo del Niño/a) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
                  placeholder="Full Name"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Date of Birth (Fecha de Nacimiento) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Diagnosis (Diagnóstico) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Insurance Provider (Proveedor de Seguro) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Member ID (Número de Miembro) <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  What location will services be in? (¿En qué lugar se prestarán los servicios?) <span className="text-[#3A331E]">*</span>
                </label>
                <div className="relative">
                  <select 
                    ...
                    defaultValue=""
                  >
                    <option value="" disabled className="text-gray-500">Select a location / Seleccione un lugar</option>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Preferred start-time for services (Hora de inicio preferida para los servicios) <span className="text-[#3A331E]">*</span>
                </label>
                <div className="relative">
                  <select 
                    ...
                    defaultValue=""
                  >
                    <option value="" disabled className="text-gray-500">Select a time / Seleccione una hora</option>
                    <option value="Morning">Morning (8:00 AM - 10:00 AM) / Mañana</option>
                    <option value="Mid-Morning">Mid-Morning (10:00 AM - 12:00 PM) / Media Mañana</option>
                    <option value="Afternoon">Afternoon (12:00 PM - 3:00 PM) / Tarde</option>
                    <option value="Late Afternoon">Late Afternoon (3:00 PM - 5:00 PM) / Tarde Noche</option>
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  How'd you hear about us? <span className="text-[#3A331E]">*</span>
                </label>
                <div className="relative">
                  <textarea 
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Front & Back of Insurance Card <span className="text-[#3A331E]">*</span>
                </label>
                <div className="w-full border border-dashed border-Primary bg-[#FFFAF0] rounded-lg py-12 px-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-[#fff7e5] transition-colors relative">
                  <input type="file" {...register("insuranceFile", { required: true })} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                    Neurological Report / Proof of Diagnosis <span className="text-[#3A331E]">*</span>
                  </label>
                  <div className="w-full border border-dashed border-Primary bg-[#FFFAF0] rounded-lg py-12 px-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-[#fff7e5] transition-colors relative">
                    <input type="file" {...register("diagnosisFile", { required: true })} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
                    <Upload className="text-[#AD3946] w-6 h-6 mb-1" strokeWidth={2} />
                    <div className="text-[#AD3946] font-semibold text-[14px] md:text-[15px]">Click to upload or drag and drop</div>
                    <div className="text-gray-500 text-[12px] md:text-[13px]">Supported: JPG, PDF. Max size: 10MB</div>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="w-full border border-dashed border-Primary bg-[#FFFAF0] rounded-lg py-12 px-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-[#fff7e5] transition-colors relative">
                    <input type="file" {...register("referralFile", { required: true })} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
                    <Upload className="text-[#AD3946] w-6 h-6 mb-1" strokeWidth={2} />
                    <div className="text-[#AD3946] font-semibold text-[14px] md:text-[15px]">Click to upload or drag and drop</div>
                    <div className="text-gray-500 text-[12px] md:text-[13px]">Supported: JPG, PDF. Max size: 10MB</div>
                  </div>
