  ...
  return (
    <div className="w-full bg-[#FAFAFA] section-padding-x section-padding-y">
      <div className=" flex flex-col items-center">
        ...
        {/* Footer Button */}
        <button className="bg-Primary hover:bg-Primary/90 text-Third font-bold text-[15px] px-8 py-3.5 rounded-[12px] flex items-center justify-center gap-2 transition-colors">
