        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Current or Intended School / Program <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
                  placeholder="Full Name"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Field of Study / Area of Training <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <select 
                    ...
                    defaultValue=""
                  >
                    <option value="" disabled className="text-gray-500">Select / Seleccione</option>
                    <option value="Full-Time">Full-Time / Tiempo completo</option>
                    <option value="Part-Time">Part-Time / Medio tiempo</option>
                    <option value="Not Enrolled Yet">Not Enrolled Yet / Aún no inscrito</option>
                  </select>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Expected Graduation / Completion Date <span className="text-[#3A331E]">*</span>
                </label>
                <input 
                  type="text" 
                  placeholder="dd/mm/yyyy"
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  How does this scholarship align with your personal and professional goals? <span className="text-[#3A331E]">*</span>
                </label>
                <textarea 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  Describe a challenge you have overcome and what it taught you. <span className="text-[#3A331E]">*</span>
                </label>
                <textarea 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                  How do you plan to give back to your community? <span className="text-[#3A331E]">*</span>
                </label>
                <textarea 
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="w-full border border-dashed border-Primary bg-[#FFFAF0] rounded-lg py-12 px-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-[#fff7e5] transition-colors relative">
                  ...
                  <div className="text-gray-500 text-[12px] md:text-[13px]">Supported: PDF, DOC, DOCX. Max size: 10MB</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-[13px] md:text-[14px] font-bold text-[#3A331E]">
                    Proof of Enrollment / Acceptance Letter <span className="text-[#3A331E]">*</span>
                  </label>
                  <div className="w-full border border-dashed border-Primary bg-[#FFFAF0] rounded-lg py-12 px-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-[#fff7e5] transition-colors relative">
                    <input type="file" {...register("proofFile", { required: true })} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
                    <Upload className="text-[#AD3946] w-6 h-6 mb-1" strokeWidth={2} />
                    <div className="text-[#AD3946] font-semibold text-[14px] md:text-[15px]">Click to upload or drag and drop</div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="w-full border border-dashed border-Primary bg-[#FFFAF0] rounded-lg py-12 px-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-[#fff7e5] transition-colors relative">
                    <input type="file" {...register("recommendationFile")} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
                    <Upload className="text-[#AD3946] w-6 h-6 mb-1" strokeWidth={2} />
                    <div className="text-[#AD3946] font-semibold text-[14px] md:text-[15px]">Click to upload or drag and drop</div>
                    <div className="text-gray-500 text-[12px] md:text-[13px]">Supported: JPG, PDF. Max size: 10MB</div>
                  </div>
          ...
          <div className="flex flex-col items-center justify-center mt-6 gap-4">
            ...
            <p className="text-gray-500 text-[12px] md:text-[13px]">
              This site is protected by reCAPTCHA and the Google <a href="#" className="underline font-medium hover:text-[#AD3946]">Privacy Policy</a> and <a href="#" className="underline font-medium hover:text-[#AD3946]">Terms of Service</a> apply.
            </p>
          </div>
