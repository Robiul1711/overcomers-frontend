...
import { X, ChevronDown, Calendar, Plus, Trash2, Loader2 } from 'lucide-react';
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <option value="">Behavior Intervention</option>
                  {/* <option value="Behavior Intervention">Behavior Intervention</option> */}
                </select>
                <ChevronDown size={16} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
              </div>
