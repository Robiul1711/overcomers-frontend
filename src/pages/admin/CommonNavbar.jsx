      ...
      <div className="flex items-center gap-3 md:gap-6 shrink-0">
        ...
        <div className="relative" ref={userMenuRef}>
          {isProfileLoading || !profile ? (
            <div className="flex items-center gap-2 bg-white border border-[#E5E7EB] rounded-lg px-2.5 py-1.5 animate-pulse shadow-sm">
            ...
            >
              ...
              <span className="hidden md:block text-sm font-medium text-[#2D2D2D] max-w-[120px] truncate group-hover:text-[#800000] transition-colors">
                {fullName}
              </span>
              <ChevronDown
                size={14}
