...
import { ArrowLeft, User, Mail, Phone, Calendar, Clock, MapPin, Layers, Info, Shield, UserCheck } from "lucide-react";
  ...
  if (isError || !caseDetails) {
    return (
      <div className="p-6 bg-white rounded-2xl shadow-sm border border-gray-100 font-poppins">
        ...
        <Link to="/director-dashboard/cases" className="mt-4 inline-flex items-center gap-2 text-Secondary hover:underline font-bold">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-50 flex flex-col gap-5">
          <div className="flex items-center gap-3 pb-3 border-b border-gray-50">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400">Personal & Contact Info</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3.5">
            <div>
              ...
              <span className="text-xs font-bold text-Third mt-0.5 block truncate">{parent?.name || "N/A"}</span>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="overflow-hidden">
                ...
                <span className="text-xs font-semibold text-gray-600 block truncate">{parent?.email || "N/A"}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <label className="text-[9px] font-bold text-gray-400 uppercase block">Phone Number</label>
                <span className="text-xs font-semibold text-gray-600 block">{parent?.phone_number || "N/A"}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <label className="text-[9px] font-bold text-gray-400 uppercase block">Session Location</label>
                <span className="text-xs font-semibold text-gray-600 block truncate">{caseDetails?.location || "N/A"}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-50 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3.5">
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Full Name</label>
              <span className="text-xs font-bold text-Third mt-0.5 block truncate">{supervisor?.name || "Unassigned"}</span>
            </div>
            ...
            {supervisor?.email && (
              <div className="flex items-center gap-2.5">
                ...
                <div className="overflow-hidden">
                  <label className="text-[9px] font-bold text-gray-400 uppercase block">Email Address</label>
                  <span className="text-xs font-semibold text-gray-600 block truncate">{supervisor?.email || "N/A"}</span>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <label className="text-[9px] font-bold text-gray-400 uppercase block">Role Designation</label>
                <span className="text-xs font-semibold text-gray-600 block">Board Certified Behavior Analyst</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-50 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3.5">
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Full Name</label>
              <span className="text-xs font-bold text-Third mt-0.5 block truncate">{employee?.name || "Unassigned"}</span>
            </div>
            ...
            {employee?.email && (
              <div className="flex items-center gap-2.5">
                ...
                <div className="overflow-hidden">
                  <label className="text-[9px] font-bold text-gray-400 uppercase block">Email Address</label>
                  <span className="text-xs font-semibold text-gray-600 block truncate">{employee?.email || "N/A"}</span>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <label className="text-[9px] font-bold text-gray-400 uppercase block">Role Designation</label>
                <span className="text-xs font-semibold text-gray-600 block">Registered Behavior Tech</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-50 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3.5">
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Start / End Time</label>
            ...
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Session Frequency</label>
      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-0.5">
              Specific day-by-day session hours for this client ({schedules?.length} total)
            </p>
          </div>
        </div>
        ...
        {schedules?.length === 0 ? (
          <div className="bg-white rounded-3xl p-8 text-center border border-gray-50 shadow-sm">
            <p className="text-gray-400 font-medium">No session schedules defined yet.</p>
          </div>
        ) : (
            ...
            {schedules?.map((sched) => (
              ...
              >
                <div className="flex items-center justify-between border-b border-gray-50 pb-2">
                  <span className="font-bold text-sm text-Third">{sched.day_of_week}</span>
