...
const DirectorNotifications = () => {
  ...
  const { data, isLoading, isError, refetch } = useClient({
    queryKey: ["directorNotifications"],
    url: "/director/notifications",
  });
  ...
  const { mutate: deleteNotification } = useMutationClient({
    url: (id) => `/director/notifications/${id}`,
    method: "delete",
    invalidateKeys: [["directorNotifications"]],
    successMessage: "Notification deleted",
  });

  // Mark single notification as read
  const { mutate: markAsRead } = useMutationClient({
    url: (id) => `/director/notifications/${id}/mark-read`,
    method: "post",
    invalidateKeys: [["directorNotifications"]],
  ...
  const { mutate: markAllRead, isPending: isMarkingAll } = useMutationClient({
    url: "/director/notifications/mark-all-read",
    method: "post",
    invalidateKeys: [["directorNotifications"]],
  ...
  const { mutate: clearAll, isPending: isClearingAll } = useMutationClient({
    url: "/director/notifications/clear-all",
    method: "post",
    invalidateKeys: [["directorNotifications"]],
