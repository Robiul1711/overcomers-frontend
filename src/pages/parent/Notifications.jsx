...
const ParentNotifications = () => {
  ...
  if (isLoading) {
    return (
      <div className="space-y-4 md:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-10">
      ...
      <div className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 md:mb-8">
          <div className="relative">
            <h3 className="text-xl md:text-2xl font-bold text-Third tracking-tight leading-tight">Sync Updates</h3>
